...
export default function LoginScreen() {
  ...
  return (
    <SafeAreaView style={s.container} edges={['top', 'bottom']}>
      ...
      <TextInput style={s.input} placeholder="Пароль" value={password} onChangeText={setPassword}
        secureTextEntry />

      <TouchableOpacity style={s.btn} onPress={handleLogin} disabled={isPending}>
        {isPending ? <ActivityIndicator color="#fff" /> : <Text style={s.btnText}>Войти</Text>}
      </TouchableOpacity>
...
const s = StyleSheet.create({
  ...
  title: { fontSize: 26, fontWeight: '500', color: '#2C2C2A', marginBottom: 24 },
